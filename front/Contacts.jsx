...
import { motion } from 'framer-motion'
     ...
     const Contacts = () =>{ 
            ...
            return (
              ...
              <div className="bg-[url('/assets/waves.svg')] bg-no-repeat bg-cover">
  ...
  <div class="container text-gray-800 px-4 md:px-12">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 mb-12">
        <div class="mb-12 lg:mb-0 text-center mx-auto">
          ...
          <h3 class="font-medium">Unites States</h3>
        </div>
        <div class="mb-12 lg:mb-0 text-center mx-auto">
          ...
          <h3 class="font-medium">Atlanta, 30188</h3>
        </div>
        <div class="mb-6 md:mb-0 text-center mx-auto">
          ...
          <h3 class="font-medium">+ 770 864 4063</h3>
        </div>
