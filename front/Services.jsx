    ...
    return (
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="max-w-screen-md mb-8 lg:mb-16">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed to help your business grow</h2>
            ...
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-12 md:space-y-0">
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">UI/UX</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white"> Copywriting</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Logos</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Consultation</h3>
