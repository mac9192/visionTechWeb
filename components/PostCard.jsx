...
<div className="bg-white shadow-lg  p-0 lg:p-8 pb-12 mb-8">
    ...
    <div className="text-center">
      <Link href={`blog/post/${post.slug}`}>
        <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-amber-300 text-lg font-medium  text-white px-8 py-3 cursor-pointer">Continue Reading</span>
      </Link>
    </div>
  </div>
</>
